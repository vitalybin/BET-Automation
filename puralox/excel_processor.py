    ...
    def process_file(self, filepath):
        ...
        fid = self.db.execute(
            '''INSERT INTO file_info 
               (file_name, date_of_measurement, time_of_measurement, comment1, comment2, comment3, comment4, serial_number, version)
               VALUES (:file_name, :date_of_measurement, :time_of_measurement, :comment1, :comment2, :comment3, :comment4, :serial_number, :version)''',
            file_info
        )
        ...
        self.db.execute(f'INSERT INTO bet_parameters ({cols}) VALUES ({placeholders})', params)
        ...
        self.db.execute(f'INSERT INTO technical_info ({tcols}) VALUES ({tph})', tech)
        ...
        # return the new file_info ID after all inserts
        return fid
